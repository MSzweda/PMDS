...
public class MDateScheduleActivity extends ExpandableListActivity
{
		...
		private ArrayList<GroupItem> convertGroupCursorToList(Cursor cursor)
		{
			...
			{
				String name = "";
				int pom = cursor.getInt(cursor.getColumnIndex(ManualSchedulesDBManager.WEEKDAY));
		...
		private ArrayList<ChildItem> convertChildrenCursorToList(int day)
		{
			...
			{
				//Log.i("PMDS","time: "+cur.getInt(cur.getColumnIndex(ManualSchedulesDBManager.HOUR_OF_DAY))+":"+cur.getInt(cur.getColumnIndex(ManualSchedulesDBManager.MINUTE_OF_HOUR))+" Is active: " + cur.getInt(cur.getColumnIndex(ManualSchedulesDBManager.IS_ACTIVE)));
				children.add(new ChildItem(
						cur.getInt(cur.getColumnIndex(ManualSchedulesDBManager.SCHEDULE_ROWID)),
						mapDayString(cur.getInt(cur.getColumnIndex(ManualSchedulesDBManager.WEEKDAY))),
						cur.getInt(cur.getColumnIndex(ManualSchedulesDBManager.HOUR_OF_DAY)),
						cur.getInt(cur.getColumnIndex(ManualSchedulesDBManager.MINUTE_OF_HOUR)),
						mapSetTo(cur.getInt(cur.getColumnIndex(ManualSchedulesDBManager.ACTION_TYPE)),cur.getInt(cur.getColumnIndex(ManualSchedulesDBManager.DEVICE_TYPE))),
						cur.getInt(cur.getColumnIndex(ManualSchedulesDBManager.DEVICE_TYPE)),
						cur.getInt(cur.getColumnIndex(ManualSchedulesDBManager.IS_ACTIVE))
						));
				cur.moveToNext();
			}
			cur.close();
